...
/**
 * Accurately merge the fields of `O` with the ones of `O1`. It is equivalent to the spread operator
 * in JavaScript. [[Union]]s and [[Optional]] fields will be handled gracefully.
 *
